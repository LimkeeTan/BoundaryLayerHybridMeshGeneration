...
///////////////////////////////////////////////////////////////////////////////
  ...
  ///////////////////////////////////////////////////////////////////////////////
    ...
    void interecursive(shellface** subfacearray, int arraysize, int axis,
        REAL, REAL, REAL, REAL, REAL, REAL, int* internum, std::vector<size_t>& intersectF);
    void detectinterfaces(std::vector<size_t>& intersectF);
...
void tetrahedralize(std::vector<size_t>& intersectF,
    tetgenbehavior* b, tetgenio* in, tetgenio* out,
